# Generated by Django 6.0.3 on 2026-05-15 15:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialty', models.CharField(choices=[('cardiology', 'Cardiology'), ('neurology', 'Neurology'), ('dermatology', 'Dermatology'), ('pediatrics', 'Pediatrics'), ('orthopedics', 'Orthopedics')], max_length=50)),
                ('department', models.CharField(choices=[('general', 'General'), ('emergency', 'Emergency'), ('surgery', 'Surgery'), ('outpatient', 'Outpatient')], max_length=50)),
